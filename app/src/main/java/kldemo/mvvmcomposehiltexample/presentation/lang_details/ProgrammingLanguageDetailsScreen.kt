...
@Composable
fun ProgrammingLanguageDetailsScreen() {

    val programmingLanguageDetailsViewModel = hiltViewModel<ProgrammingLanguageDetailsViewModel>()
    ...
    Column(
        ...
        if (programmingLanguageDetailsViewState.isLoading) {
            ...
            Column(
                ...
                Text(programmingLanguageDetailsViewState.programmingLanguageDetails.description)
            }
        }
    }
}
